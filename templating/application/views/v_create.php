...
<div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100" style="margin-left: 70px;">
    <h2 style="padding-top: 100px;"><b>Mendaftarkan Data Mahasiswa</b></h2>
    <form action="<?php echo base_url(); ?>index.php/mahasiswa/create_data" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="univ_major" class="form-control">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" name="shs_major" class="form-control">
        </div>
        <br>
        <h5><b>Contact</b></h5>
        <hr>
